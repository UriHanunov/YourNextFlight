...
public class ManagerSearch extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        DatabaseFlights.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FlightList adapter = new FlightList(ManagerSearch.this, flightList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewFlight= (ListView) findViewById(R.id.listViewSearch);

        flightList= new ArrayList<>();

        DatabaseFlights = FirebaseDatabase.getInstance().getReference("flights");

//        DatabaseFlights.addListenerForSingleValueEvent();
